...
| `tutorial.*`   | 74      | `src/game/tutorial.ts` (the 16 programs), `src/widgets/tutorial-panel/ui/tutorial-panel.ts` (the 48 prose keys and the panel's own five), `src/pages/game/index.ts` (the four of the finish overlay), `src/widgets/level-switcher/ui/level-switcher.ts` (the block caption)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
### The learning track — 74 `tutorial.*` keys
