...
| `page.description`                  | Elevator Saga, redesigned: write JavaScript to move people through a building efficiently. 19 levels, a…       | twice: the `description` meta, and the `og:description` one                                                                                                           |
