...
The catalogue holds **310 keys** in two locales. `src/i18n/en.ts` is the reference — its text is
...
see: the two sit on adjacent lines of a 310-key file and nothing in the file marks them as a
