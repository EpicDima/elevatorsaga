...
| `page.description`                  | Elevator Saga, redesigned: write JavaScript to move people through a building efficiently. 40 levels in…       | twice: the `description` meta, and the `og:description` one                                                                                                           |
