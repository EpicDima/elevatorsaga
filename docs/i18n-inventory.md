...
| `skyscraper.sky11.briefing.html`     | The hall buttons are gone. Instead o… | markup; `<em>` around _destination dispatch_, `<code>` around the event, the method that books a car, and the two ways a car is sent  |
