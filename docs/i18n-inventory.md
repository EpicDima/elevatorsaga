...
| `page.description`                  | Elevator Saga, redesigned: write JavaScript to move people through a building efficiently. A learning…         | twice: the `description` meta, and the `og:description` one                                                                                                           |
