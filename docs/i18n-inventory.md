...
The catalogue holds **469 keys** in two locales. `src/i18n/en.ts` is the reference — its text is
...
| `skyscraper.*` | 3       | `src/game/skyscraper.ts`, whose getters read all three; the card they end up on is `src/widgets/level-briefing/ui/level-briefing.ts`, which is handed the finished strings and so names no key itself                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
### `src/game/skyscraper.ts` — 3 `skyscraper.*` keys
...
Measured, not guessed: this starter loses at the level's pinned seed with 35 of the 40 delivered.
`src/game/skyscraper.ts` records that figure and the two that bracket it, and says what re-measuring
means.
