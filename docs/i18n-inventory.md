...
| `skyscraper.sky11.briefing.html`     | The hall buttons are gone. Instead o… | markup; `<em>` around _destination dispatch_ and `<code>` around the event and the two methods the mechanic is played through         |
