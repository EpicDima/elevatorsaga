...
The catalogue holds **363 keys** in two locales. `src/i18n/en.ts` is the reference — its text is
...
see: the two sit on adjacent lines of a 363-key file and nothing in the file marks them as a
