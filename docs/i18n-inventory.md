...
The catalog holds **486 keys** in two locales, each locale spread over two files. `src/i18n/en.ts`
...
```sh
grep -hoE '^  "[^"]+"' src/i18n/en.ts src/i18n/docs-en.ts | wc -l       # 486
grep -hoE '^  "[^"]+"' src/i18n/en.ts src/i18n/docs-en.ts | tr -d '"' | cut -d. -f1 | sort | uniq -c | sort -rn
```

| Prefix         | Keys    | What reads them                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `docs.*`       | 89      | one of them, `docs.basics.example.code`, by `src/ui/completions.ts`, and it is the one that stays in `src/i18n/en.ts` for that reason; the other 88 by nothing, and they live in `src/i18n/docs-en.ts` and `src/i18n/docs-ru.ts`, which only `src/page.test.ts` imports                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `completion.*` | 35      | `src/ui/completions.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
### `documentation.html` — the reference page, 89 `docs.*` keys
...
### `src/ui/completions.ts` — 35 `completion.*` keys
