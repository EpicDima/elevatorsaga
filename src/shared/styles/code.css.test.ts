 ...
 * tutorial answer and every documentation sample in the same colors the live
...
/**
 * Every color the editor draws text in — the eight syntax colors plus the
 ...
 * a selection, and a ninth color added to `editorSyntaxTheme` without being
...
describe("ds code palette on the code background", () => {
  ...
  // eight tutorial answers' syntax colors), `editorSyntaxTheme` (the live
  ...
  // so no value here can recolor what is selected. The floor exists so that
