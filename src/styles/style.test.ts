...
describe("ds palette on the lesson card", () => {
  // The learning track's panel is drawn on --ds-panel now, with three surfaces
  ...
  it.each([
    ...
    // on --ds-raised is the shared control pairing, measured above.)
...
describe("kbd", () => {
  it("draws a key cap instead of the browser default", () => {
    ...
    // control-shaped mark .btn and .task-open draw, rather than a colour this
    // file would have no test for. The pair is --ds-text
