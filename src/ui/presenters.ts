 ...
 *
 * Prefers the stack, as the legacy banner did, and degrades through the message
 * to a plain description rather than letting a thrown object render as
 * `[object Object]`.
 *
...
/**
 * Draws — or clears — the "there is a problem with your code" banner.
 *
 ...
 * @param error - The error to report, or `undefined` to clear the banner.
 */
