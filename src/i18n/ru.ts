...
export const RU_MESSAGES: MessageCatalog<"ru"> = {
  ...
  "page.description":
    ...
    "пассажиров. Обучающий трек, уровни про то, как работают настоящие лифтовые системы, песочница " +
    "любого размера и повторяемые запуски.",
  "page.imageAlt":
  ...
  "page.tagline":
    ...
    "оформлении: обучающий трек, который начинается с пустого редактора, уровни про то, как " +
    "работают настоящие лифтовые системы, песочница со зданием любого размера и запуски, которые " +
