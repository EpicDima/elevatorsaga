...
export const RU_MESSAGES: MessageCatalogue<"ru"> = {
  ...
  // на кнопке они не помещаются: «Учебное задание 1» просит 133px из 96px
  // внутри неё, и вся учебная дорожка читалась как «Учебное за...». Слово
  // «учебное» здесь и не нужно — его уже сказал заголовок блока над плитками.
  // Уровню и песочнице отдельный ключ не нужен: «Уровень {number}» и
  // «Песочница» и так их имена.
  "game.levelSwitcher.tutorialTriggerLabel": "Задание {number}",
