...
elevator.goToFloor(2); // Всё равно добавится — очередь: 2, 3, 2`,
  ...
  // рядом со зданием. Английский каталог объясняет, почему на уровень здесь три
  // ключа, а не восемь, как на учебной дорожке.
  //
  ...
  // Уровень 1.
  "skyscraper.sky1.title": "Одиннадцать этажей ради одного пассажира",
  "skyscraper.sky1.briefing.html":
    'Двенадцать этажей, три кабины, и рейс судится по числу перемещений, а не по секундам. Такое здание — первое в игре, где кабина больше времени едет, чем стоит под посадку, а круг, который она повторяет, — до вызова, по своим остановкам и обратно, — в лифтовом деле называют <em>временем кругового рейса</em>. Каждый следующий уровень блока — свой способ этот круг сократить. Здесь для этого не дают ничего нового: программа, с которой вы начинаете, отправляет к вызову следующую по очереди кабину, и кабина, поехавшая на вызов с одиннадцатого этажа, поднимается на одиннадцать этажей, чтобы отвезти вниз <span class="emphasis-color">одного</span> человека. Кабины не медленные, и их не мало. Их посылают по одному поручению за раз.',
