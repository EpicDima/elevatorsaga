...
export const RU_MESSAGES: MessageCatalog<"ru"> = {
  ...
  "page.stats.avgWaitTimeTitle":
    "От момента, когда пассажир появился в здании, до момента, когда он вышел на нужном ему этаже, так что поездка входит сюда наравне с ожиданием",
  ...
  "page.stats.maxWaitTimeTitle":
    "Самая большая такая величина среди всех пассажиров: она растёт, пока кто-то ещё в пути, и обратно уже не опускается",
