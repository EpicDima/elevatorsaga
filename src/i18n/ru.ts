...
export const RU_MESSAGES: MessageCatalog<"ru"> = {
  ...
  "page.description":
    ...
    "пассажиров. Обновлённая версия оригинальной игры: больше уровней, обучающий трек, песочница " +
    "и повторяемые запуски.",
  "page.imageAlt":
  ...
  "page.tagline":
    ...
    "оформлении: обновлённая версия оригинальной игры, в которой больше уровней, есть обучающий " +
    "трек, начинающийся с пустого редактора, песочница для экспериментов и запуски, которые " +
