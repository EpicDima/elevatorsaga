...
export const RU_MESSAGES: MessageCatalogue<"ru"> = {
  ...
  "page.hint.html":
    "В редакторе: <kbd data-mod-key>Ctrl</kbd>+<kbd>Enter</kbd> применяет программу. <kbd data-mod-key>Ctrl</kbd>+<kbd>S</kbd> сохраняет её. <kbd>Tab</kbd> добавляет отступ. <kbd>Esc</kbd> убирает фокус из редактора. Потяните полоску над этой строкой, чтобы изменить высоту редактора, или наведите на неё фокус и нажимайте <kbd>↑</kbd> и <kbd>↓</kbd>; двойной щелчок вернёт исходную высоту.",
