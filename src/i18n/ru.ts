...
export const RU_MESSAGES: MessageCatalog<"ru"> = {
  ...
  "page.description":
    ...
    "пассажиров. 40 уровней в двух главах и обучающем треке, песочница любого размера и повторяемые запуски.",
  "page.imageAlt":
  ...
  "page.tagline":
    ...
    "оформлении: 40 уровней в двух главах и обучающем треке, который начинается с пустого " +
    "редактора, песочница со зданием любого размера и запуски, которые можно повторить в точности.",
