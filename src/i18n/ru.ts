...
elevator.goToFloor(2); // Всё равно добавится — очередь: 2, 3, 2`,
  ...
  // -------------------------------------------------------- учебная дорожка
  // «Учебное задание» — это задание дорожки, «задание №N» — задание игры; в
  // панели дорожки первое пишется с уточнением, чтобы игрок не спутал одно с
  // другим, и по той же причине кнопка выхода ведёт «к заданиям игры».
  ...
  "tutorial.task5.goal":
    "Отправляйте лифт туда, куда его действительно зовут: перевезите 15 пассажиров и не дайте никому прождать дольше 37 секунд.",
  ...
  "tutorial.panel.position": "Учебное задание {number} из {count}",
  ...
  "tutorial.finish.message":
    "Восемь заданий, и последнее из них было заданием №1: те же три этажа, тот же лифт, те же пятнадцать пассажиров за шестьдесят секунд. Программа, которая сейчас в редакторе, его решает, так что заберите программу с собой.",
  "tutorial.finish.toChallenges": "Перейти к заданию №1 с этой программой",
};
